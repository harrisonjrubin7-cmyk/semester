# Packet 01 — Identity, tenancy and authorization

**Execution order:** 01 of 08  
**Status:** implementation handoff

## Objective

Implement identity, tenancy and authorization as a bounded increment in the existing Semester repository without deleting or silently repurposing a working capability. Fetch and inspect current `main` before editing.
...
CAP-005, CAP-008, CAP-010, CAP-012

## Dependencies

00-baseline-foundation

## Repository areas

supabase/migrations; supabase/functions; app/server/institution; app/src/lib/institutional-access.ts
