# Packet 08 — Institutional pilot and rollout

**Execution order:** 08 of 08  
**Status:** implementation handoff

## Objective

Implement institutional pilot and rollout as a bounded increment in the existing Semester repository without deleting or silently repurposing a working capability. Fetch and inspect current `main` before editing.
...
docs/institutional-rollout; app/scripts; supabase; .github/workflows
