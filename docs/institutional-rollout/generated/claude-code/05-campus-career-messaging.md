# Packet 05 — Campus, career and messaging systems

**Execution order:** 05 of 08  
**Status:** implementation handoff

## Objective

Implement campus, career and messaging systems as a bounded increment in the existing Semester repository without deleting or silently repurposing a working capability. Fetch and inspect current `main` before editing.
...
CAP-041–CAP-055, CAP-058–CAP-060

## Dependencies

02-canonical-academic-data, 04-study-creation-ai

## Repository areas

app/server/institution; app/src/screens; app/src/lib; supabase/migrations
