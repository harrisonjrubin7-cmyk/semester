# Packet 06 — Integrations and operations

**Execution order:** 06 of 08  
**Status:** implementation handoff

## Objective

Implement integrations and operations as a bounded increment in the existing Semester repository without deleting or silently repurposing a working capability. Fetch and inspect current `main` before editing.
...
CAP-008–CAP-012, CAP-043, CAP-050–CAP-051

## Dependencies

01-identity-tenancy-authorization, 02-canonical-academic-data

## Repository areas

app/server/institution; supabase/functions; app/src/lib/connect.ts; .github/workflows
