# Packet 00 — Baseline and foundation

**Execution order:** 00 of 08  
**Status:** implementation handoff

## Objective

Implement baseline and foundation as a bounded increment in the existing Semester repository without deleting or silently repurposing a working capability. Fetch and inspect current `main` before editing.
...
app/scripts; app/src/lib; docs/institutional-rollout
