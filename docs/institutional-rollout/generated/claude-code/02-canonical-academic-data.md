# Packet 02 — Canonical academic data

**Execution order:** 02 of 08  
**Status:** implementation handoff

## Objective

Implement canonical academic data as a bounded increment in the existing Semester repository without deleting or silently repurposing a working capability. Fetch and inspect current `main` before editing.
...
CAP-009, CAP-011, CAP-015, CAP-021–CAP-024, CAP-044–CAP-045

## Dependencies

01-identity-tenancy-authorization

## Repository areas

supabase/migrations; app/src/lib; app/src/data; app/server/institution
