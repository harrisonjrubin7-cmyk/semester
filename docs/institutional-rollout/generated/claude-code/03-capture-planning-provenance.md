# Packet 03 — Capture, planning and provenance

**Execution order:** 03 of 08  
**Status:** implementation handoff

## Objective

Implement capture, planning and provenance as a bounded increment in the existing Semester repository without deleting or silently repurposing a working capability. Fetch and inspect current `main` before editing.
...
CAP-001–CAP-004, CAP-013–CAP-020

## Dependencies

02-canonical-academic-data

## Repository areas

app/src/screens; app/src/state; app/src/lib; supabase/functions
