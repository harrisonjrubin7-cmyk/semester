...
flowchart TD
    ...
    B --> C["Document or presentation"]
    B --> D["Spreadsheet or math tools"]
    B --> E["Design or video tools"]
    C --> F["Collaboration and feedback"]
    D --> F
    E --> F
    F --> G["Direct submission"]
    G --> H["Grade and instructor feedback"]
```
