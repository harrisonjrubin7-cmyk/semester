...
It is continued at item **184** by [`UNIVERSITY_OS_REQUIREMENTS.md`](UNIVERSITY_OS_REQUIREMENTS.md), which applies the same connective argument to the systems the university runs.
