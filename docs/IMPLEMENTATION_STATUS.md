...
Local acceptance is recorded in [`docs/institutional-rollout/intelligence-expansion-evidence.md`](institutional-rollout/intelligence-expansion-evidence.md): 12,640 tests passed, file-order/shuffle/two-timezone suites agreed, both production builds passed, desktop and phone browser smoke passed, and all 30 PostgreSQL policy suites passed. This does not prove live SSO, SCIM, LMS access, employer/alumni data, sent actions, official-record writes or legal permission to record.
