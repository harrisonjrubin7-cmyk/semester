-- per_record_sync_with_soft_deletes — applied to production on 2026-09-08 at 05:39:43 UTC.
--
-- **There is deliberately no SQL in this file, and that is the whole point.**
--
-- Production's ledger has a row for version `20260908053943`. Supabase's
...
--
-- Its statements are in [`../history/20260908053943_per_record_sync_with_soft_deletes.sql`](../history/20260908053943_per_record_sync_with_soft_deletes.sql), byte-for-byte as the ledger reported them, checked by `migrationhistory.test.ts` against `MANIFEST`. That directory is a record, not a migration set.
--
