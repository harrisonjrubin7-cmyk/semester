-- wrap_auth_uid_in_helpers — applied to production on 2026-09-07 at 14:13:24 UTC.
--
-- **There is deliberately no SQL in this file, and that is the whole point.**
--
-- Production's ledger has a row for version `20260907141324`. Supabase's
...
--
-- Its statements are in [`../history/20260907141324_wrap_auth_uid_in_helpers.sql`](../history/20260907141324_wrap_auth_uid_in_helpers.sql), byte-for-byte as the ledger reported them, checked by `migrationhistory.test.ts` against `MANIFEST`. That directory is a record, not a migration set.
--
