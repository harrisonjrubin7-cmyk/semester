-- forms_relation_grants — applied to production on 2026-09-21 at 14:47:11 UTC.
--
-- **There is deliberately no SQL in this file, and that is the whole point.**
--
-- Production's ledger has a row for version `20260921144711`. Supabase's
...
--
-- Its statements are in [`../history/20260921144711_forms_relation_grants.sql`](../history/20260921144711_forms_relation_grants.sql), byte-for-byte as the ledger reported them, checked by `migrationhistory.test.ts` against `MANIFEST`. That directory is a record, not a migration set.
--
