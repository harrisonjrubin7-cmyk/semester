-- classmates_any_school — applied to production on 2026-09-08 at 05:30:10 UTC.
--
-- **There is deliberately no SQL in this file, and that is the whole point.**
--
-- Production's ledger has a row for version `20260908053010`. Supabase's
...
--
-- Its statements are in [`../history/20260908053010_classmates_any_school.sql`](../history/20260908053010_classmates_any_school.sql), byte-for-byte as the ledger reported them, checked by `migrationhistory.test.ts` against `MANIFEST`. That directory is a record, not a migration set.
--
