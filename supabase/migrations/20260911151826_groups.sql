-- groups — applied to production on 2026-09-11 at 15:18:26 UTC.
--
-- **There is deliberately no SQL in this file, and that is the whole point.**
--
-- Production's ledger has a row for version `20260911151826`. Supabase's
...
--
-- Its statements are in [`../history/20260911151826_groups.sql`](../history/20260911151826_groups.sql), byte-for-byte as the ledger reported them, checked by `migrationhistory.test.ts` against `MANIFEST`. That directory is a record, not a migration set.
--
