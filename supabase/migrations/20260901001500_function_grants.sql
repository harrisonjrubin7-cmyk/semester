...
--
-- **This was live, not theoretical.** `20260901001200_invites.sql` and
-- `20260901001400_referrals.sql` were applied to the project on 21 September
...
-- has to be safe to run *early* as well. `20260901001300_access_log.sql` has
