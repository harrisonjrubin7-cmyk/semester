-- rls_initplan_and_policy_overlap — applied to production on 2026-09-07 at 14:10:19 UTC.
--
-- **There is deliberately no SQL in this file, and that is the whole point.**
--
-- Production's ledger has a row for version `20260907141019`. Supabase's
...
--
-- Its statements are in [`../history/20260907141019_rls_initplan_and_policy_overlap.sql`](../history/20260907141019_rls_initplan_and_policy_overlap.sql), byte-for-byte as the ledger reported them, checked by `migrationhistory.test.ts` against `MANIFEST`. That directory is a record, not a migration set.
--
