-- harden_security_definer_helpers — applied to production on 2026-09-07 at 13:48:23 UTC.
--
-- **There is deliberately no SQL in this file, and that is the whole point.**
--
-- Production's ledger has a row for version `20260907134823`. Supabase's
...
--
-- Its statements are in [`../history/20260907134823_harden_security_definer_helpers.sql`](../history/20260907134823_harden_security_definer_helpers.sql), byte-for-byte as the ledger reported them, checked by `migrationhistory.test.ts` against `MANIFEST`. That directory is a record, not a migration set.
--
