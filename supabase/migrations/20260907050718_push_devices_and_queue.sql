-- push_devices_and_queue — applied to production on 2026-09-07 at 05:07:18 UTC.
--
-- **There is deliberately no SQL in this file, and that is the whole point.**
--
-- Production's ledger has a row for version `20260907050718`. Supabase's
...
--
-- Its statements are in [`../history/20260907050718_push_devices_and_queue.sql`](../history/20260907050718_push_devices_and_queue.sql), byte-for-byte as the ledger reported them, checked by `migrationhistory.test.ts` against `MANIFEST`. That directory is a record, not a migration set.
--
