...
**Status.** S1, S2 and S3 are done, in the commits this file's history names.
S4 is half done, and the half that is left is a design decision rather than a
mechanical one — see the row itself, which corrects two numbers I got wrong the
first time.
