...
| `gateway_health_probe` | **One singleton row, overwritten on every readiness probe** | `private.gateway_journal_health()` in `supabase/migrations/20260924184500_gateway_action_journal.sql` | Upsert; contains only the last successful write time |
