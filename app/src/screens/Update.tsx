        ...
        <>
          ...
          <Blueprint plain style={{ padding: '11px 13px' }}>
            ...
            {told.because.length > 0 && (
              <div style={{ fontSize: 'var(--type-sm)', opacity: 'var(--app-text-dim)', marginTop: 'var(--sp-3)', lineHeight: 'var(--leading-normal)' }}>
      ...
      {text.trim().length >= ENOUGH && (
        <>
          {claudeReady ? (
            ...
            <div style={{ fontSize: 'var(--type-sm)', opacity: 'var(--app-text-dim)', marginTop: 'var(--sp-4)', lineHeight: 'var(--leading-normal)' }}>
