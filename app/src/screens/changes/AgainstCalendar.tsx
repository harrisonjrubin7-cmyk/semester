...
export function AgainstCalendar() {
  ...
  return (
    <Folding name="AgainstCalendar">
      ...
      {source === 'feed' ? (
        <div style={{ fontSize: 'var(--type-sm)', opacity: 'var(--app-text-dim)', marginTop: 'var(--sp-5)', lineHeight: 'var(--leading-relaxed)' }}>
                ...
                return (
                  <Blueprint plain key={m.item.id} style={{ padding: '13px 14px', marginBottom: 9 }}>
                    ...
                    >
                      ...
                      <span style={{ fontSize: 'calc(11.5px * var(--text-scale, 1))', opacity: 'var(--app-text-dim)' }}>{movedLine(m)}</span>
                    </div>
                    <div style={{ fontSize: 'calc(11.5px * var(--text-scale, 1))', opacity: 0.5, marginTop: 'var(--sp-3)', lineHeight: 'var(--leading-normal)' }}>
