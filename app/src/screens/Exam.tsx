    ...
    return (
      <Page bottom={26}>
        ...
        <Blueprint style={{ padding: '12px 14px', marginTop: 14 }}>
          ...
          <div style={{ fontSize: 'var(--type-sm)', opacity: 'var(--app-text-dim)', marginTop: 5 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-3)', marginTop: 9 }}>
                {q.options.map((option, n) => {
                  ...
                  return (
                    ...
                    >
                      <span style={{ flex: 'none', opacity: 'var(--app-text-dim)', fontSize: 'calc(12.5px * var(--text-scale, 1))' }}>
                        {letter(n)}
                      </span>
            ...
            {marking && (
              <>
                ...
                {q.kind === 'choice' ? (
                  ...
                  <>
                    <div style={{ fontSize: 'calc(11.5px * var(--text-scale, 1))', opacity: 'var(--app-text-dim)', margin: '9px 0 6px' }}>
