        ...
        [
          {
            ...
            run: () =>
              say(
                `A cell starting with = is a formula, and there are ${FUNCTIONS.length} of them — totals and averages, lookups, dates and working days, text, and the money ones a finance course runs on. Formulas · All functions searches them by name or by what you want worked out. All computed on this device.`,
              ),
          },
          {
            id: 'help.errors',
