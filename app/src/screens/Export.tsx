...
export function Export() {
  ...
  return (
    <Page bottom={26}>
      ...
      {PARTS.map((part) => (
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0, padding: '12px 0' }}>
            ...
            <div style={{ fontSize: 'calc(11.5px * var(--text-scale, 1))', opacity: 'var(--app-text-dim)', marginTop: 'var(--sp-1)', lineHeight: 1.4 }}>
              {part.blurb}
            </div>
          </div>
        </div>
      ...
      {clouds.length === 0 && (
        <div style={{ fontSize: 'var(--type-sm)', opacity: 'var(--app-text-dim)', marginTop: 'var(--sp-6)', lineHeight: 'var(--leading-relaxed)' }}>
