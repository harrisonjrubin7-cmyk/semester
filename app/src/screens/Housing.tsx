    ...
    <Page className="campus-personal" bottom={26} folds={false}>
      ...
      <Blueprint style={{ paddingBlock: 'calc(15px * var(--density, 1))', paddingInline: 'calc(16px * var(--density, 1))', marginTop: 'var(--sp-6)' }}>
        ...
        <div
          ...
          style={{ fontSize: 'var(--type-display)', lineHeight: 'var(--leading-display-xs)', marginTop: 'var(--sp-3)', textWrap: 'pretty' }}
        >
        ...
        {packLine(exams, moveOut, now) ? (
          <div style={{ fontSize: 'var(--type-base)', color: 'var(--app-dim)', marginTop: 'var(--sp-3)', lineHeight: 'var(--leading-relaxed)' }}>
            {packLine(exams, moveOut, now)}
          </div>
        ) : null}
      </Blueprint>
