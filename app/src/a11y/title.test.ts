...
describe('the component that writes it', () => {
  ...
  it('is mounted in every layout', () => {
    ...
    // adding another means adding its mount rather than raising this.
    //
    // It was four while the browser shell existed. That shell was a second
    // copy of the workspace's and went in the seventh pass (E4 in
    // `SIMPLIFY-AUDIT.md`), taking its mount with it.
