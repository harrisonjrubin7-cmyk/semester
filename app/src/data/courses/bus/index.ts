...
const bus: CourseModule = {
  ...
  items: [
    ...
    },
    {
      id: 'bus-sona-acct',
      c: 'bus',
      title: 'Create your SONA account',
      kind: 'Research',
      month: 8,
      day: 1,
      dueTime: '5:00p',
      ...
      where: 'SONA',
      detail:
        'Nothing is worth points yet, but without the account you cannot book a session, and the first window closes on Sep 17.',
      quote: 'SONA account due 5 PM.',
      source: 'Syllabus Draft 8262026.pdf · Session 2',
    },
    {
      id: 'bus-sona',
      c: 'bus',
      title: 'SONA session 1 — last day of window 1',
      // Dated to the day the window CLOSES, not the day it opens. The opening
      // date was here before and it is the wrong one to show: an item dated
      // Sep 8 scrolls out of Coming up a week before the deadline that
      // actually costs the money.
      kind: 'Research',
      month: 8,
      day: 17,
      dueTime: 'Window is Sep 8–17',
      weight: 'Half of 5%',
      where: 'Center Bldg, Suite 245',
      detail:
        'One session in each window. Two in the same window earns only 2.5%, and missing this one loses the full 5% permanently — it cannot be made up in window 2.',
      quote:
    ...
    },
    {
      id: 'bus-sona2',
      c: 'bus',
      title: 'SONA session 2 — last day of window 2',
      kind: 'Research',
      month: 9,
      day: 8,
      dueTime: 'Window is Sep 29 – Oct 8',
      weight: 'Half of 5%',
      where: 'Center Bldg, Suite 245',
      detail: 'The second half of the research credit. Also the last day it can be earned at all.',
      quote: 'Research participation: 5%.',
      source: 'Syllabus Draft 8262026.pdf · Research participation',
    },
    {
      id: 'bus-read-jars',
      c: 'bus',
      title: 'Read the Simply Good Jars case',
      kind: 'Reading',
      month: 8,
      day: 10,
      ...
      weight: 'Required',
      where: 'Brightspace',
      detail: 'Comes with the consumer behaviour session — Ch. 3.',
      quote: 'Read the Simply Good Jars case.',
      source: 'Syllabus Draft 8262026.pdf · Session 5',
    },
    {
      id: 'bus-case',
      c: 'bus',
