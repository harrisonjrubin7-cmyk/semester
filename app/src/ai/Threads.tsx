        ...
        {sections.flatMap((section) => [
          ...
          <li key={t.id} style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            >
              <span style={ONE_LINE}>
                {t.pinned && (
                  <span aria-label="Pinned" title="Pinned" style={{ opacity: 'var(--app-text-dim)' }}>
                    ▪{' '}
                  </span>
                )}
              ...
              */}
              {found && (
                <span style={{ ...UNDER, opacity: 'var(--app-text-dim)', fontStyle: 'italic' }}>{found}</span>
              )}
            </button>
        ...
        {archived.length > 0 && (
          <li style={{ marginTop: 'var(--sp-4)' }}>
            <button
              ...
              style={{ ...ACT, opacity: 'var(--app-text-dim)', padding: '0 var(--sp-5)' }}
            >
