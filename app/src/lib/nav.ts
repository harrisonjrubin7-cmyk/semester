...
export const DESTINATIONS: Destination[] = [
  ...
  },
  {
    ...
    label: 'Getting there',
    short: 'Map',
    blurb: 'When to leave for your next class, a map you can search, and directions to anywhere.',
    keywords: 'map maps directions route walk drive transit bus navigate campus nashville where building room address google apple search find location openstreetmap nearby when to leave leave by walk time how far distance next class late running late get there arrive',
    group: 'Campus',
    taskTags: ['campus'],
    root: 'maps',
  },
